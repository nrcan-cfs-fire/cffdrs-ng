...
# December 2025 (last updated February 2026)
#
...
cd CHANGE/TO/PATH/TO/cffdrs-ng/FWI/C
...
# Ensure the corresponding NG_FWI.h and util.h header files are in the same folder.
