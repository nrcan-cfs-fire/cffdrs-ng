...
plot_compare <- function(df, main="")
{
  ...
  return(ggplot() + ggtitle(main) + geom_line(mapping=aes(TIMESTAMP, DC), data=result, linetype="dashed", color="red") + geom_line(mapping=aes(TIMESTAMP, DC), data=result_old))
}
