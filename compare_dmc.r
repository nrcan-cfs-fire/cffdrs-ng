...
plot_compare <- function(df, main="")
{
  ...
  return(ggplot() + ggtitle(main) + geom_line(mapping=aes(TIMESTAMP, DMC), data=result, linetype="dashed", color="red") + geom_line(mapping=aes(TIMESTAMP, DMC), data=result_old))
}
